...
export const HouseListPage = () => {
  ...
  return (
    <div>
      ...
      <div className="house-list grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1  gap-6 m-auto lg:w-[1024px] w-full pb-16 pt-10 px-4">
        {filteredList.map((list) => (
          <div className="w-full max-w-sm bg-[#ffff] border border-gray-200 rounded-lg shadow">
            <Link to="#">
              <img
